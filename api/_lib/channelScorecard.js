...
// 2026-08-17 — pinterest(승급 대기·크론 utm 예정)·flipboard(RSS 신디케이션
// 신설) 채널 추가. 유입 0이어도 줄이 남아야 "버스가 아직 안 왔다"가 보인다.
const CHANNELS = ['naver', 'kakao', 'ig', 'threads', 'x', 'tiktok', 'youtube', 'newsletter', 'chatgpt', 'pinterest', 'flipboard'];
