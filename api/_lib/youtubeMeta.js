...
const CELEB_LEXICON = [
  ...
  /* 2026-08-21 추가 — PAP 에서 반복해서 다루는데 목록에 없어 [ NEWS ] 로
     떨어지던 이름들. 기사 경로는 tags 가 받쳐줘서 안 드러났고, 파일명만
     보는 스토리 쇼츠 경로에서 처음 드러났다(조니워커 변우석 → [ NEWS ]).
     목록은 원래 완전할 수 없다 — 그래서 폴백이 있다. 자주 나오는 것만 채운다. */
  '변우석', '공유', '안효섭', '김재원', '지드래곤', 'g-dragon', '빅뱅',
  '스트레이키즈', '다니엘 시비', 'daniel seavey', '혁오', '콜드', '올린',
