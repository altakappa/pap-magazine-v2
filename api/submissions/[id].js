  ...
  try {
    ...
    if (req.method === 'PUT') {
      ...
      if (_noInsta.length) {
        ...
        return res.status(400).json({ code: 'LOOK_INSTAGRAM_REQUIRED', message: 'Every brand credit needs a valid Instagram handle (letters, numbers, dots, underscores). Missing or invalid: ' + _lbl, items: _noInsta });
      }
