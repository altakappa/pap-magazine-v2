...
(function(){
  ...
  function injectStyles(){
    ...
    style.textContent=[
      ...
      '#betaNotice .bn-feedback{font-size:11px;line-height:1.6;color:rgba(255,255,255,.5);margin:18px 0 0;letter-spacing:.01em}',
      '#betaNotice .bn-feedback a{color:rgba(255,255,255,.85);text-decoration:underline;text-underline-offset:2px;transition:color .2s}',
