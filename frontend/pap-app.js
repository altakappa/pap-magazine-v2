...
function isPremium(){try{var u=sessionStorage.getItem('pap-user');if(!u)return false;var user=JSON.parse(u);return user&&user.subscription==='premium';}catch(e){return false;}}
function isStandardOrAbove(){try{var u=sessionStorage.getItem('pap-user');if(!u)return false;var user=JSON.parse(u);return user&&(user.subscription==='standard'||user.subscription==='premium');}catch(e){return false;}}
...
(function(){
  ...
  if(window.location.protocol !== 'file:'){
    loadJSON('data/films.json', filmAllData, window._papFilmRenderCards);
    loadJSON('data/articles.json', artData, window._papArticleRenderCards);
    loadJSON('data/editorials.json', edData);
    loadJSON('data/creators.json', creatorData);
    loadJSON('data/shorts.json', shortsData, window._papShortsRender);
