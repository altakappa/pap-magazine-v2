...
ok('정적 마크업(영어 기본값)도 6장·공동작업자 혜택·종이 잡지', /<li>At least 6 high-resolution photos/.test(html) && /glAddBody"><ul>(?:<li>[^<]*<\/li>)*<li>Yearly Premium: choose up to 5 PAP members \(free members included\) as Instagram collaborators on your editorial's post<\/li>/.test(html) && /glTermsBody"><ul><li>[^<]*<\/li><li>Submitted work may be published in a future PAP print magazine/.test(html));
